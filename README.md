...
A: ووردبريس يسمح فقط بأنواع معينة من الملفات لأسباب أمنية. الإضافة تدعم الآن تلقائياً ملفات ISO, ZIP, RAR, 7Z, TAR, GZ, و BZ2. إذا كان لديك ملفات من أنواع أخرى، يمكنك استخدام إضافة مثل `pjw-mime-config` لإضافة أنواع ملفات إضافية.
...
- ✅ دعم الملفات المضغوطة (ZIP, RAR, 7Z, TAR, GZ, BZ2) - **مكتمل**
